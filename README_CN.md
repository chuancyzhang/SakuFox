...
SakuFox 是一个基于 Agentic 自主智能体与人机协同 (HITL) 的交互式数据分析平台。它能将自然语言转化为受限业务域内的可解释 SQL，允许用户通过交互修正 AI 逻辑并将其沉淀为可复用的业务经验。
...
### 🛠️ **业务经验沉淀 (Skill Precipitation)**
将零散的分析过程转化为持久的业务资产。一旦分析路径得到验证，点击“保存为经验”即可自动提炼高质量的业务规则、指标定义和 SQL 逻辑。
...
感谢Apache Superset项目，本项目借鉴了其前端页面设计，也引用了它的demo数据。 Superset是一个非常优秀的开源数据分析平台，值得大家学习和使用。
